...
private slots:
    ...
    void on_DeviceData_SaveButton_clicked();

    void on_DeviceData_Download_clicked();
...
private:
    ...
    int StateValue;           //global oven state
...
#define MPCAL_NOINCREASE_TIMEOUT        600//10 minutes * 60 seconds
    ...
    char flg_readT_K2=0, flg_sendT_K2=0;
    int cont_sendT_K2=0;

    char flg_readT_C2=0, flg_sendT_C2=0;
    int cont_sendT_C2=0;

    char flg_readT_K_fact=0, flg_sendT_K_fact=0;
    int cont_sendT_K_fact=0;

    char flg_readT_C_fact=0, flg_sendT_C_fact=0;
    int cont_sendT_C_fact=0;
    ...
    char flg_sendExit=0;                //Send Exit command, to exit current process
    int cont_sendExit=0;
    ...
    //**********************Device ID, SerialNumber, and FW Version

    char flg_readID=0, flg_readVersion=0;
    char cont_sendID=0, cont_sendVersion=0;
    //*******************************************
    ...
    char flg_2ptCalMsjC=0;
    char flg_2ptCalMsjD=0;

    char flg_2ptCalNewData=0;
    //*******************************************
